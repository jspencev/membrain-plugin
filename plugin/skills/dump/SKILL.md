...
name: dump
description: >-
  Dump knowledge from this session into the user's braindump (their personal
  permanent memory) via the braindump MCP dump tool. Use when the user runs
  /braindump:dump or says to remember/dump something — and proactively, without
...
Deposit knowledge from this session onto the user's braindump tape via the
