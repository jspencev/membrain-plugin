...
name: load
description: >-
  Load context from the user's braindump (their personal permanent memory) via
  the braindump MCP ask tool. Use when the user runs /braindump:load, asks
...
Orient yourself using the user's braindump — their permanent memory of past
